...
window.onload = function() {
    ...
    recordButton.addEventListener("click", function(){
        ...
        if (isRecording) {
            ...
            postProject(document.getElementById("records-grid").innerHTML);
...
{      
    var xmlhttp = null;
        ...
        xmlhttp.open("POST","http://127.0.0.1:8080/receive",true);
    ...
    // temp.action = "http://127.0.0.1:8080/receive";
    // temp.method = "post";
